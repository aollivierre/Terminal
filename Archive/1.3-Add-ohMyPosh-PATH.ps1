...
# Add-EnvPath -Path 'C:\Users\aollivierre\AppData\Local\Programs\oh-my-posh\bin' -Container 'Machine'
# Add-EnvPath -Path 'C:\Users\Admin-Abdullah2\AppData\Local\Programs\oh-my-posh\bin' -Container 'Machine'
