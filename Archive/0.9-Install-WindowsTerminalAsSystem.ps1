...
WinGet-WrapperDetection -id 'Microsoft.WindowsTerminal' -Targetversion '' -AcceptNewerVersion $true


WinGet-Wrapper -PackageName Microsoft.WindowsTerminal -ArgumentList "install --exact --id Microsoft.WindowsTerminal --silent --accept-package-agreements --accept-source-agreements --scope Machine"
