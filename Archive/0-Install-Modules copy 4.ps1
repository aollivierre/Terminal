function InstallAndUpdateModules {
    ...
    Process {
        ...
        $galleryModules = $allModules | Where-Object { $_.Path -notlike '*\System32\*' }
...
#                 }
#                 catch {
#                     Write-Error "Failed to parse module '$($module.Name)' manifest details. Error: $_"
#                 }
#             }
#         }
...
function Get-ModuleDetails {
    ...
    # [CmdletBinding()]
    Begin {
        # Initialize the list to store module details
        $moduleDetails = @()
        $allModules = @()
    }
