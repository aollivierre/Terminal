...
WinGet-WrapperDetection -id 'JanDeDobbeleer.OhMyPosh' -Targetversion '' -AcceptNewerVersion $true


WinGet-Wrapper -PackageName JanDeDobbeleer.OhMyPosh -ArgumentList "install --exact --id JanDeDobbeleer.OhMyPosh --silent --accept-package-agreements --accept-source-agreements --scope Machine"
